...
Java-based digital remake of the board game [Marrakech](https://boardgamegeek.com/boardgame/29223/marrakech), where players play as rug merchants competing against each other. The aim of the game is to get the most number of coins / dirhams (money) by placing rugs on the board.<br>
